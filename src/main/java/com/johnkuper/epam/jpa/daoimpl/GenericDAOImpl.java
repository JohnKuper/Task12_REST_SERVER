...
import com.johnkuper.epam.jpa.daointerface.GenericDAO;
import com.johnkuper.epam.jpaservice.mapper.EntityDomainFieldRegistator;
...
public class GenericDAOImpl<Entity, Domain, IdType> implements
	...
	public GenericDAOImpl() {
		...
		getEntityManager();
		if (mapper == null) {
			mapper = new OrikaMapper(new EntityDomainFieldRegistator());
		}
